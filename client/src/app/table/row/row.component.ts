...
export class RowComponent implements OnInit {
  ...
  @Input() user: User = { id: -1, firstName: "", lastName: "", email: "", phoneNumber: "", role: "", address: "", customerName: "" };
  ...
  saveRow(){
    // this.mode.emit({ editable: false, index: this.rowNumber })
    ...
    let role =(<HTMLTableElement>document.getElementById(`row${this.rowNumber}Role`)).innerHTML;
    ...
    let updatedData:User={id:+id,firstName:firstName,middleName:middleName, lastName:lastName, email:email, phoneNumber:phoneNumber, role:role,address:address,customerName:customerName}
